...
module.exports = {
  ...
  checkout: async (req, res) => {
    try {
      ...
      const payload = {
        ...
        // comment dulu karena blm dibuat di middleware
  ...
  history: async (req, res) => {
    try {
      ...
      if (status.length) {
        criteria = {
          ...criteria,
          status: { $regex: `${status}`, $options: "i" }, // tidak case sensitif $options: i
        };
      }
  ...
  historyDetail: async (req, res) => {
    try {
      ...
      // saya tambahkan field player, untuk mencegah player mendapatkan detail transction milik player lain
      // agar detail transction yang tampil benar benar milik player yang membeli voucher tersebut
      ...
      if (req.file) {
        ...
        src.on("end", async () => {
          try {
            ...
            // remove gambar sebelumnya dengan yang baru
